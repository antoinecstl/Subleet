...
export default function InformationPage() {
  ...
  // Theme detection (identique à pricing)
  useEffect(() => {
    const detectTheme = () => {
    ...
    <div className="min-h-screen p-6 relative overflow-hidden">
      ...
      <div className="relative z-10 content-container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {/* Feature 1 */}
          <div className={`glass-card rounded-xl p-6 hover-scale shadow-lg ${theme === 'light' ? 'bg-white' : 'bg-gray-900'} transition-colors`}>
        ...
        <div className={`glass-card rounded-xl p-8 mb-16 shadow-lg ${theme === 'light' ? 'bg-white' : 'bg-gray-900'} transition-colors`}>
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Use Case 1 */}
            <div className={`glass-card rounded-xl overflow-hidden shadow-lg ${theme === 'light' ? 'bg-white' : 'bg-gray-900'} transition-colors`}>
              <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-muted mb-3">
                Our AI assistants are built on the latest large language models, optimized to understand
        ...
        {/* CTA Section */}
        <div className={`glass-card rounded-xl p-8 text-center shadow-lg ${theme === 'light' ? 'bg-white' : 'bg-gray-900'} transition-colors`}>
          ...
          <p className="text-lg text-muted mb-6 max-w-2xl mx-auto">
            Start your journey with Subleet today and experience the benefits of custom AI solutions tailored to your specific business needs.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/sign-up" className="btn-gradient px-8 py-3">
              Get Started
            </Link>
